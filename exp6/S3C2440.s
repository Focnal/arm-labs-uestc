...
;IntVectorTable
				...
				DCD   0x4000		;HandleCAM		#   4		; Added for 2440.
				DCD   0x4000		;HandleBATFLT	#   4
				DCD   0x4000		;HandleTICK		#   4
				DCD   0x4000		;HandleWDT		#   4
				DCD   0x4000		;HandleTIMER0 	#   4
				DCD   0x4000		;HandleTIMER1 	#   4
				DCD   0x4000		;HandleTIMER2 	#   4
				DCD   0x4000		;HandleTIMER3 	#   4
				DCD   0x4000		;HandleTIMER4 	#   4
				DCD   0x4000		;HandleUART2  	#   4
				;@0x3000-0060
				DCD   0x4000		;HandleLCD 		#   4
				DCD   0x4000		;HandleDMA0		#   4
				DCD   0x4000		;HandleDMA1		#   4
				DCD   0x4000		;HandleDMA2		#   4
				DCD   0x4000		;HandleDMA3		#   4
				DCD   0x4000		;HandleMMC		#   4
				DCD   0x4000		;HandleSPI0		#   4
				DCD   0x4000		;HandleUART1		#   4
				DCD   0x4000		;HandleNFCON		#   4		; Added for 2440.
				DCD   0x4000		;HandleUSBD		#   4
				DCD   0x4000		;HandleUSBH		#   4
				DCD   0x4000		;HandleIIC		#   4
				DCD   0x4000		;HandleUART0 	#   4
				DCD   0x4000		;HandleSPI1 		#   4
				DCD   0x4000		;HandleRTC 		#   4
				DCD   0x4000		;HandleADC 		#   4
				;@0x3000_00A0
